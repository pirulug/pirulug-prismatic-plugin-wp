...
if (!class_exists('Prismatic')) {
	...
	final class Prismatic {
		...
		private function constants() {
			...
			if (!defined('PRISMATIC_VERSION'))
				define('PRISMATIC_VERSION', '3.5');
			if (!defined('PRISMATIC_REQUIRE'))
				define('PRISMATIC_REQUIRE', '4.7');
			if (!defined('PRISMATIC_NAME'))
				define('PRISMATIC_NAME', 'Prismatic');
			if (!defined('PRISMATIC_AUTHOR'))
				define('PRISMATIC_AUTHOR', 'Jeff Starr');
			if (!defined('PRISMATIC_HOME'))
				define('PRISMATIC_HOME', 'https://perishablepress.com/prismatic/');
			if (!defined('PRISMATIC_URL'))
				define('PRISMATIC_URL', plugin_dir_url(__FILE__));
			if (!defined('PRISMATIC_DIR'))
				define('PRISMATIC_DIR', plugin_dir_path(__FILE__));
			if (!defined('PRISMATIC_FILE'))
				define('PRISMATIC_FILE', plugin_basename(__FILE__));
			if (!defined('PRISMATIC_SLUG'))
				define('PRISMATIC_SLUG', basename(dirname(__FILE__)));
